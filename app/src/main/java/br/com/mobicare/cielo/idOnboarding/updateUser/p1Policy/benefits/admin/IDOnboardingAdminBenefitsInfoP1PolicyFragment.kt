package br.com.mobicare.cielo.idOnboarding.updateUser.p1Policy.benefits.admin
...
import br.com.mobicare.cielo.databinding.FragmentIdOnboardingAdminAccessBinding
...
class IDOnboardingAdminBenefitsInfoP1PolicyFragment : BaseFragment(),
    ...
    private var binding: FragmentIdOnboardingAdminAccessBinding? = null

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentIdOnboardingAdminAccessBinding.inflate(layoutInflater, container, false)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        analytics.logIDScreenView(ANALYTICS_ID_SCREEN_VIEW_COMPLETE_PROFILE_SETUP + UserObj.MainRoleEnum.ADMIN.description , this.javaClass)
    ...
    private fun setupView() {
        ...
        binding?.apply{
            ...
            includePersonalInfo.apply {
                tvRoleName.text =
                    getString(R.string.access_manager_role_group_card_description_admin_title)
        ...
        binding?.apply {
            btSendNow.setOnClickListener {
                ...
                analytics.logIDOnClickSendPictures(
                    ...
                    UserObj.MainRoleEnum.ADMIN.description
                )
            ...
            btGoToHelpCenter.setOnClickListener {
                it.isEnabled = false
                analytics.logIDOnClickHelpCenter(UserObj.MainRoleEnum.ADMIN.description)
    ...
    private fun goToSendPhotosNow() {
        findNavController().navigate(
            when (IDOnboardingFlowHandler.checkpointP2) {
                IDOCheckpointP2.DOCUMENT_PHOTO_UPLOADED -> IDOnboardingAdminBenefitsInfoP1PolicyFragmentDirections.actionIdOnboardingAdminBenefitsFragmentToIdOnboardingPicturesSelfieGuideFragment()
                else -> IDOnboardingAdminBenefitsInfoP1PolicyFragmentDirections.actionIdOnboardingAdminBenefitsFragmentToIdOnboardingPicturesSelectDocFragment()
            }
        )
    }

    private fun goToSendPhotosLater() {
        findNavController().navigate(IDOnboardingAdminBenefitsInfoP1PolicyFragmentDirections.actionIdOnboardingAdminBenefitsFragmentToIdOnboardingPicturesLaterFragment(
            UserObj.MainRoleEnum.ADMIN.description
        ))
    }
    ...
    private fun setupStepRestartBottomSheet() {
        if (userStatus.onboardingStatus?.userStatus?.restartP2 == true) {
            ...
            IDOnboardingFlowHandler.showCustomBottomSheet(
                activity = this@IDOnboardingAdminBenefitsInfoP1PolicyFragment.activity,
