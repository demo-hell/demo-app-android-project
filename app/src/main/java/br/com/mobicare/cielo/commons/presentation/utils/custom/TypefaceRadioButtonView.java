...
/**
 * Created by benhur.souza on 04/07/2017.
 */

public class TypefaceRadioButtonView extends AppCompatRadioButton {
    public static Map<String, Typeface> typefaceCache = new HashMap();

    public TypefaceRadioButtonView(Context context) {
        super(context);
    }

    public TypefaceRadioButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (!isInEditMode()) {
    ...
    public TypefaceRadioButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
