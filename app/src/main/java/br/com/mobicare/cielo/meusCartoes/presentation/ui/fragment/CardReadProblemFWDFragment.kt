...
class CardReadProblemFWDFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun create(currentScreenPath: String): CardReadProblemFWDFragment {

            val params = Bundle()

            val startCardActivationFragment = CardReadProblemFWDFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_fwd_read_problem,
                container, false)
    ...
    override fun onResume() {
        ...
        buttonUnlockCreditCard.setOnClickListener {
            ...
            requireActivity().startActivity<CardPhotoDescriptionActivity>(
                    CardPhotoDescriptionActivity.RESEND_DOC to true)
        }
