package br.com.mobicare.cielo.pix.ui.extract
...
import br.com.mobicare.cielo.databinding.ActivityPixExtractNavigationFlowBinding
import br.com.mobicare.cielo.databinding.ToolbarMainBinding
import br.com.mobicare.cielo.extensions.gone
import br.com.mobicare.cielo.extensions.visible
import br.com.mobicare.cielo.pix.constants.EMPTY
import br.com.mobicare.cielo.pix.constants.IS_HOME_PIX_ARGS

class PixExtractNavigationFlowActivity : BaseLoggedActivity(), CieloNavigation {

    private var navigationListener: CieloNavigationListener? = null
    private var isShowHelpMenu: Boolean = true
    private var bundle: Bundle? = null

    private lateinit var binding: ActivityPixExtractNavigationFlowBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPixExtractNavigationFlowBinding.inflate(layoutInflater)
    ...
    override fun onSupportNavigateUp(): Boolean {
        if (findNavController(this, R.id.nav_host_fragment).navigateUp().not())
            this.finish()
    ...
    override fun getData(): Any? = intent?.getBooleanExtra(IS_HOME_PIX_ARGS, false)
