package br.com.mobicare.cielo.cancelSale.presentation
...
import br.com.mobicare.cielo.databinding.CancelSaleFlowActivityBinding

class CancelSaleFlowActivity : BaseLoggedActivity(), CieloNavigation {
    private var navigationListener: CieloNavigationListener? = null
    private var _binding: CancelSaleFlowActivityBinding? = null
    private val binding get() = _binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _binding = CancelSaleFlowActivityBinding.inflate(layoutInflater)
        setContentView(binding?.root)
        setupToolbar(
            binding?.toolbarInclude?.root as Toolbar, resources.getString(R.string.cancelamento_detalhes)
        )
    }
