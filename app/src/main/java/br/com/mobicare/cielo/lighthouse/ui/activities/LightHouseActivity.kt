...
class LightHouseActivity : BaseActivity(), LightHouseContract.View {
    ...
    override fun showLightHouseProductScreen() {
        val fragment = LightHouseHiredFragment()
        this.menu?.let {
            fragment.addArgument(APP_ANDROID_MENU, it)
        }
        fragment.addInFrame(supportFragmentManager, R.id.frameLightHouseContent)
    }
