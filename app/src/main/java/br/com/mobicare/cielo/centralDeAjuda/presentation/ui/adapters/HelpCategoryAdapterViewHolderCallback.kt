...
import kotlinx.android.synthetic.main.content_categories_item.view.card_view_main
import kotlinx.android.synthetic.main.item_new_technical_support.view.*

class HelpCategoryAdapterViewHolderCallback : DefaultViewListAdapter.OnBindViewHolderPositon<HelpCategory> {
    ...
    override fun onBind(item: HelpCategory, holder: DefaultViewHolderKotlin, position: Int, lastPositon: Int) {
        ...
        holder.mView.card_view_main.setOnClickListener {
