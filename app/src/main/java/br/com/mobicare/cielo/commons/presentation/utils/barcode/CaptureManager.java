package br.com.mobicare.cielo.commons.presentation.utils.barcode;
...
public class CaptureManager {
     ...
     * @param savedInstanceState saved stateCd, containing orientation lock
     */
    ...
    protected void returnResult(BarcodeResult rawResult) {
        if (activity instanceof OnBarcodeScanResult){
            ((OnBarcodeScanResult)activity).onBarcodeScanSuccess(rawResult);
        }else {
    ...
    protected void displayFrameworkBugMessageAndExit() {
        ...
        builder.setTitle(activity.getString(R.string.barcode_text_need_access_camera_title));
        //builder.setMessage(activity.getString(com.google.zxing.client.android.R.string.zxing_msg_camera_framework_bug));
        builder.setMessage(activity.getString(R.string.barcode_text_need_access_camera));
...
//                finish();
    ...
    public interface OnBarcodeScanResult{
        void onBarcodeScanSuccess(BarcodeResult result);
    }
}
