package br.com.mobicare.cielo.pix.ui.qrCode.decode
...
import br.com.mobicare.cielo.databinding.ActivityPixDecodeQrCodeNavigationFlowBinding
import br.com.mobicare.cielo.databinding.ToolbarMainBinding
import br.com.mobicare.cielo.extensions.gone
import br.com.mobicare.cielo.extensions.visible
import br.com.mobicare.cielo.pix.constants.EMPTY

class PixDecodeQrCodeNavigationFlowActivity : BaseLoggedActivity(), CieloNavigation {

    private var navigationListener: CieloNavigationListener? = null
    private var isShowHelpMenu: Boolean = true
    private var bundle: Bundle? = null

    private lateinit var binding: ActivityPixDecodeQrCodeNavigationFlowBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPixDecodeQrCodeNavigationFlowBinding.inflate(layoutInflater)
        ...
        with(intent?.extras ?: Bundle()) {
            ...
            navHostFragment.navController.setGraph(R.navigation.nav_graph_decode_qrcode, this)
        }
    ...
    override fun getData(): Any? = intent
