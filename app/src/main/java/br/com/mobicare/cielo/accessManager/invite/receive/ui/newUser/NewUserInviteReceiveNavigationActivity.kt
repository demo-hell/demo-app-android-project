package br.com.mobicare.cielo.accessManager.invite.receive.ui.newUser
...
import br.com.mobicare.cielo.databinding.ActivityNewUserInviteReceiveNavigationBinding
import br.com.mobicare.cielo.extensions.gone
import br.com.mobicare.cielo.extensions.visible

class NewUserInviteReceiveNavigationActivity : BaseActivity(), CieloNavigation {

    private var binding: ActivityNewUserInviteReceiveNavigationBinding? = null
    private var navigationListener: CieloNavigationListener? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityNewUserInviteReceiveNavigationBinding.inflate(layoutInflater)
