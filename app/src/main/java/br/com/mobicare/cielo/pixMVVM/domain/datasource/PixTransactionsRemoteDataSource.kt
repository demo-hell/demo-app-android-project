...
interface PixTransactionsRemoteDataSource {
    suspend fun getTransferDetails(endToEndId: String?, transactionCode: String?): CieloDataResult<PixTransferDetail>
    suspend fun transferWithKey(otpCode: String?, request: PixTransferKeyRequest?): CieloDataResult<PixTransferResult>
    suspend fun transferToBankAccount(otpCode: String?, request: PixTransferBankAccountRequest?): CieloDataResult<PixTransferResult>
    suspend fun getTransferBanks(): CieloDataResult<List<PixTransferBank>>
    suspend fun cancelTransferSchedule(otpCode: String, request: PixScheduleCancelRequest): CieloDataResult<PixTransferResult>
