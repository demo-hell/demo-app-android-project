...
class GetFilteredCanceledSellsUseCase(private val repository: MySalesFiltersRemoteRepository) {

    suspend operator fun invoke(params: GetBrandsSalesFiltersParams): CieloDataResult<ResultPaymentTypesBO> {
        return repository.getFilteredCanceledSells(params)
    }
}