package br.com.mobicare.cielo.idOnboarding.updateUser.p1Policy.benefits.analyst
...
import br.com.mobicare.cielo.databinding.FragmentIdOnboardingAnalystAccessBinding
...
class IDOnboardingAnalystBenefitsInfoP1PolicyFragment : BaseFragment(),
    ...
    private var binding: FragmentIdOnboardingAnalystAccessBinding? = null

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentIdOnboardingAnalystAccessBinding.inflate(layoutInflater, container, false)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        analytics.logIDScreenView(ANALYTICS_ID_SCREEN_VIEW_COMPLETE_PROFILE_SETUP + UserObj.MainRoleEnum.ANALYST.description , this.javaClass)
    ...
    private fun setupView() {
        ...
        binding?.apply{
            ...
            includePersonalInfo.apply {
                tvRoleName.text =
                    getString(R.string.access_manager_role_group_card_description_analyst_title)
        ...
        binding?.apply {
            btSendNow.setOnClickListener {
                ...
                analytics.logIDOnClickSendPictures(
                    ...
                    UserObj.MainRoleEnum.ANALYST.description
                )
            ...
            btGoToHelpCenter.setOnClickListener {
                it.isEnabled = false
                analytics.logIDOnClickHelpCenter(UserObj.MainRoleEnum.ANALYST.description)
    ...
    private fun goToSendPhotosNow() {
        findNavController().navigate(
            when (IDOnboardingFlowHandler.checkpointP2) {
                IDOCheckpointP2.DOCUMENT_PHOTO_UPLOADED -> IDOnboardingAnalystBenefitsInfoP1PolicyFragmentDirections.actionIdOnboardingAnalystBenefitsFragmentToIdOnboardingPicturesSelfieGuideFragment()
                else -> IDOnboardingAnalystBenefitsInfoP1PolicyFragmentDirections.actionIdOnboardingAnalystBenefitsFragmentToIdOnboardingPicturesSelectDocFragment()
            }
        )
    }

    private fun goToSendPhotosLater() {
        findNavController().navigate(IDOnboardingAnalystBenefitsInfoP1PolicyFragmentDirections.actionIdOnboardingAnalystBenefitsFragmentToIdOnboardingPicturesLaterFragment(
            UserObj.MainRoleEnum.ANALYST.description
        ))
    }
    ...
    private fun setupStepRestartBottomSheet() {
        if (userStatus.onboardingStatus?.userStatus?.restartP2 == true) {
            ...
            IDOnboardingFlowHandler.showCustomBottomSheet(
                activity = this@IDOnboardingAnalystBenefitsInfoP1PolicyFragment.activity,
