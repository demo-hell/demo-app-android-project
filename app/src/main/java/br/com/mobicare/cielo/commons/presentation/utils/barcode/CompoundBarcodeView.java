...
public class CompoundBarcodeView extends FrameLayout {
    ...
    private ResultPerSecond resultPerSecondListener;
    ...
    private class WrappedCallback implements BarcodeCallback {
        ...
        public void possibleResultPoints(List<ResultPoint> resultPoints) {
            for (ResultPoint point : resultPoints) {
                if (resultPerSecondListener != null) {
                    resultPerSecondListener.onResult();
                }
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = attributes.getResourceId(
                com.google.zxing.client.android.R.styleable.zxing_view_zxing_scanner_layout, R.layout.view_barcode_scanner);
    ...
    public void initializeFromIntent(Intent intent) {
        ...
        if (intent.hasExtra(Intents.Scan.CAMERA_ID)) {
            int cameraId = intent.getIntExtra(Intents.Scan.CAMERA_ID, 0);
            if (cameraId >= 0) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_CAMERA:
                // Handle these events so they don't launch the CameraVO app
                return true;
    ...
    public void setListenerPerSecond(ResultPerSecond listenerPerSecond) {
        this.resultPerSecondListener = listenerPerSecond;
    }
    ...
    public interface ResultPerSecond {
        void onResult();
    }
