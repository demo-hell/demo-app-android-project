...
class PixReceiptRefundSentViewBuilder(
    ...
    override val headerInformation get() = HeaderInformation(
        pixType = getString(R.string.pix_extract_title_card_reversal_debit),
    ...
    override val fields get() = listOf(
        Field(R.string.pix_extract_detail_label_refund_value, refund?.amount?.toPtBrRealString()),
    ...
    override val originalTransactionFields get() = listOf(
        ...
        Field(R.string.pix_extract_detail_label_original_value_payer, transfer?.debitParty?.name),
        Field(R.string.pix_extract_detail_label_document, transfer?.debitParty?.nationalRegistration),
        Field(R.string.pix_extract_detail_label_institution, transfer?.debitParty?.bankName),
