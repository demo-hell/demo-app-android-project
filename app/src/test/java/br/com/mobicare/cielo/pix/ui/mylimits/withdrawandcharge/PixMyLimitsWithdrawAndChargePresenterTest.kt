...
class PixMyLimitsWithdrawAndChargePresenterTest {

    @Mock
    lateinit var view: PixMyLimitsWithdrawAndChargeContract.View
    ...
    private lateinit var presenter: PixMyLimitsWithdrawAndChargePresenter
    ...
    private val servicesGroupPixName = PixServicesGroupEnum.CHARGE_WITHDRAW.name
    ...
    private val myLimitsWithdrawAndChargeResponse = Gson().fromJson(
        MyLimitsTestFactory.myLimitsWithdrawAndChargeJson, PixMyLimitsResponse::class.java)
    ...
    fun setup() {
        ...
        presenter = PixMyLimitsWithdrawAndChargePresenter(
            view,
            userPreferences,
            repository,
    ...
    fun `it should call onShowMyLimits on success result of getMyLimits`() {
        // given
        doReturn(Observable.just(myLimitsWithdrawAndChargeResponse))
            .whenever(repository)
            .getLimits(servicesGroupNameCaptor.capture(), beneficiaryTypeCaptor.capture())

        // when
        presenter.getMyLimits()
        ...
        assertTrue(responseCaptor.allValues.contains(myLimitsWithdrawAndChargeResponse))
    }
