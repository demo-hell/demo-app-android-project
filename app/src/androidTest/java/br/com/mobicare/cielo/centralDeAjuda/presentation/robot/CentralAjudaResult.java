...
//    }
//
//    public CentralAjudaResult checkHeaderDuvidasTecnicas(String title){
//        onView(withId(R.id.textview_central_ajuda_duvidas_tecnicas)).check(matches(withText(title)));
//        return this;
//    }
//
//    public CentralAjudaResult checkHeaderDuvidasGerais(String title){
//        onView(withId(R.id.textview_central_ajuda_duvidas_gerais)).check(matches(withText(title)));
//        return this;
//    }
//
//    public CentralAjudaResult checkHeaderChatOnline(String title){
//        onView(withId(R.id.textview_central_ajuda_chat_online)).check(matches(withText(title)));
//        return this;
//    }
//
