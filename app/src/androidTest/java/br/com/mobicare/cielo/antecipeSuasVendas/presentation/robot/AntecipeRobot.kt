...
class AntecipeRobot: ActivityInstrumentationTestCase2<FragmentUtilActivity>(FragmentUtilActivity::class.java) {
    ...
    fun setup() {
        ...
        MenuPreference.instance.saveLooseAntecipation(activity, Antecipacao.ELIGIBLE)
        MenuPreference.instance.saveScheduledAntecipation(activity, Antecipacao.ELIGIBLE)
